...
public class Lesson04Ex01Controller {
	...
	public String addUserView() {
		return "lesson04/addUser"; // jsp view 경로(view 경로: string)
	}
	
	// 회원가입 insert => 입력 성공 화면
	@PostMapping("/add-user") // post만 허용
	...
	public String latestUserView(Model model) { //  Model: view 화면에 데이터를 넘겨주는 객체
		...
		// Model 주머니에 데이터를 담는다. => jsp에서 꺼내 씀
		model.addAttribute("result", user); // key:result
